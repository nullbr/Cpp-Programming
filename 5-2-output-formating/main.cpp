...
int main(){
    ...
    // Display text placing a new line
    ...
    std::cout << "This is a message..." << std::endl <<std::flush; // std::flush makes shure message is sent to the terminal
    ...
    std::cout.unsetf(std::ios::scientific | std::ios::fixed); // Hack to reset std to defaults
    std::cout << "a : " << a << std::endl;
    std::cout << "b : " << b << std::endl;
    std::cout << "c : " << c << std::endl;
